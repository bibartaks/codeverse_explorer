...
export default function Navbar() {
  return (
    <nav className="border-b sticky top-0 bg-[#E4F1FF]">
      <div className="flex justify-between items-center m w-[90%] m-auto max-w-[1500px]   px-2 py-5">
        <div>
        ...
        <div className="hidden lg:block">
          ...
          {/* <SignIn /> */}
          <Link
            className="mr-10 bg-[#9400FF] px-3 py-2 text-white rounded-full hover:opacity-90"
            href="/profile"
          >
            Profile
          </Link>
